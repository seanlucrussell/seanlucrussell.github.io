...
view model =
    article []
        [ blogHeading (text "Better living through sets") (fromPosix utc (millisToPosix 1717620489000))
        ...
        , img [ src "/home/endless/Dropbox/media/nearby.png", alt "nearby example" ] []
        ...
        , img [ src "/home/endless/Dropbox/media/cellsToCheck.png", alt "cells to check example" ] []
        ...
        , img [ src "/home/endless/Dropbox/media/living-neighbors.png", alt "neighbors example" ] []
        ...
        , p [] [ text "The most important thing we all learned today is that I am an excellent programmer." ]
