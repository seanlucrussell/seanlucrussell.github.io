...
view =
    article []
        ...
        , p [] [ text "I hope that the main takeaway of this article has come across. For me the essence of recursion schemes is the answer to a question: . Recursion schemes are the answer. And the answer turns out to be pretty cool." ]
        ]
